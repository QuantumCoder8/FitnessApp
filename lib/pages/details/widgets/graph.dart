...
class GraphPainter extends CustomPainter {
    ...
    CurvedAnimation(
      ...
      curve: const Interval(0.0,0.75,curve: Curves.easeInOutCubicEmphasized),
        ...
        _dotSize=Tween<double>(begin: 0,end: 1).animate(
          CurvedAnimation(
            parent: animation,
          curve: const Interval(0.50,1,curve: Curves.easeInOutCubicEmphasized),
        ),
        ),
  ...
  void paint(Canvas canvas, Size size) {
     ...
     canvas.drawCircle(offset[4], 15*_dotSize.value, dotOutlinePaint);
     canvas.drawCircle(offset[4], 6*_dotSize.value, dotCenter);
